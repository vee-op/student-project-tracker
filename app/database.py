...
# Connect to Vault
vault_client = hvac.Client(url='http://102.37.142.227:8200') #Ip will will be provided in the class or use localhost if you have a vault server on you host maching
